...
const recipes = [
	{
		...
		image: './../images/sweet-potato-waffles.png',
		recipeIngredient: [
			'2 separated eggs',
			'1/4 C Oil',
			'1/4 tsp salt',
	...
	},
	{
		...
		image: './images/chicken-with-cream.png',
		recipeIngredient: [
	...
	},
	{
		...
		image: './images/oven-roasted-potato-slices.png',
		recipeIngredient: [
			'3-4 Medium Potatoes',
			'1 Tbsp Olive oil',
	...
	},
	{
		...
		image: './images/black-beans-and-rice.png',
		recipeIngredient: [
	...
	},
	{
		...
		image: './images/gooseberry-cake-with-vanilla-cream-and-crumble.png',
		recipeIngredient: [
			'For the Cake Base:',
...
function displayRecipe(recipe) {
	...
	document.getElementById("recipe-tag").textContent = recipe.tags[0] || "";
	document.getElementById("recipe-title").textContent = recipe.name;

	const rounded = Math.round(recipe.rating);
	document.getElementById("recipe-rating").textContent = "⭐".repeat(rounded);
...
function runSearch() {
	...
	let results = recipes.filter((recipe) => {
		...
		const inDesc = recipe.description.toLowerCase().includes(keyword);
	...
	if (results.length > 0) {
		...
		document.getElementById("recipe-title").textContent = "No results found";
		document.getElementById("recipe-description").textContent =
			"Try a different keyword.";
		document.getElementById("recipe-img").src = "";
		document.getElementById("recipe-tag").textContent = "";
		document.getElementById("recipe-rating").textContent = "";
	}
}
